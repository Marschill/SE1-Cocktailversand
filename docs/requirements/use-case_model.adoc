...
* *UC04*: Bestellung liefern (BarMitarebeiter)
* *UC05*: Bestellugn aufgbeben (Kunde)
* *UC06*: Katalog anzeigen (Kunde)
* *UC06*: Katalog pflegen (Kunde)
* *UC07*: Bar kontaktieren (Kunde)
* *UC08*: Bestellung ändern (Barmitarbeiter)
* *UC09*: Lieferung verfolgen(Kunde)




== Use Case Diagramm
image::UseCaseDiagram1.jpg[]
[plantuml, "{diagramsdir}/use-case-diagram.puml", svg]
....
include::{plantumlsdir}/use-case-diagram.puml[]
....
